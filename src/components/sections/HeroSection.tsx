  ...
  return (
    <Box
      ...
      sx={{
        ...
        display: 'flex',
        alignItems: 'center',
        background: 'linear-gradient(135deg, rgba(0, 176, 240, 0.3) 0%, rgba(0, 76, 151, 0.07) 100%)',
        color: '#333333',
        overflow: 'hidden',
        pt: { xs: 10, md: 12 }, // Account for header height
      }}
    >
          ...
          >
            ...
            <Box sx={{ pr: { md: 4 } }}>
              ...
              <motion.div variants={fadeInUp}>
                ...
                >
                  El ERP colombiano que simplifica la facturación, inventario y ventas para tu negocio.
                </Typography>
              </motion.div>
              ...
              <motion.div variants={fadeInUp}>
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                  ...
                  >
                    ✅ Sin permanencia • ✅ Soporte 24/7 • ✅ Datos seguros en Colombia
                  </Typography>
                  <Typography 
                    variant="caption" 
                    sx={{ 
                ...
                >
                  ...
                  >
                    ...
                    <Box sx={{ position: 'relative', zIndex: 1, textAlign: 'center' }}>
                      ...
                      <Typography variant="h6" sx={{ color: '#004C97', mb: 2, fontWeight: 600 }}>
                        Dashboard Inteligente
                      </Typography>
                      <Typography variant="body2" sx={{ color: '#333333', maxWidth: 280, mx: 'auto' }}>
                        Visualiza el estado de tu negocio en tiempo real con gráficos y métricas clave
                      </Typography>
                    </Box>
        ...
        >
          ...
          >
            <Box
              sx={{
                width: 24,
                height: 40,                  border: '2px solid rgba(0, 76, 151, 0.4)',
                  borderRadius: '12px',
                  position: 'relative',
                  '&::after': {
                    content: '""',
